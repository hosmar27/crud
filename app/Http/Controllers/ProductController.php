...
class ProductController extends Controller
{
    public function index(Request $request){
        ...
        if(!empty($keyword)){
            $products = Product::where('name','LIKE',"%keywird%")
    ...
    public function store(Request $request){
        ...
        $product->save();
        return redirect()->route('products.index')->with('sucess','Product Added sucessfuly');
    }
    ...
    public function update(Request $request, Product $product){
        ...
        return redirect()->route('products.index')->with('update','Product has been updated sucessfully');
    }
